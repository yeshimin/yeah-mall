...
import com.yeshimin.yeahboot.merchant.third.kuaidi100sdk.api.ThirdPlatformOrderCommitTask;
import com.yeshimin.yeahboot.merchant.third.kuaidi100sdk.api.ThirdPlatformOrderUploadNum;
import com.yeshimin.yeahboot.merchant.third.kuaidi100sdk.api.ThirdPlatformStoreAuth;
import com.yeshimin.yeahboot.merchant.third.kuaidi100sdk.contant.CompanyConstant;
import com.yeshimin.yeahboot.merchant.third.kuaidi100sdk.contant.OrderStatus;
import com.yeshimin.yeahboot.merchant.third.kuaidi100sdk.contant.ThirdPlatformConstant;
...
import com.yeshimin.yeahboot.merchant.third.kuaidi100sdk.request.ThirdPlatform.CommitTaskReq;
import com.yeshimin.yeahboot.merchant.third.kuaidi100sdk.request.ThirdPlatform.StoreAuthReq;
import com.yeshimin.yeahboot.merchant.third.kuaidi100sdk.request.ThirdPlatform.UploadNumReq;
import com.yeshimin.yeahboot.merchant.third.kuaidi100sdk.response.ThirdPlatform.CommitTaskResp;
import com.yeshimin.yeahboot.merchant.third.kuaidi100sdk.response.ThirdPlatform.StoreAuthResp;
import com.yeshimin.yeahboot.merchant.third.kuaidi100sdk.response.ThirdPlatform.ThirdPlatformBaseResp;
