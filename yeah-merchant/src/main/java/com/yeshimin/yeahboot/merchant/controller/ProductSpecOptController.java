 ...
 */
@RestController
@RequestMapping("/productSpecOpt")
public class ProductSpecOptController extends CrudController<ProductSpecOptMapper, ProductSpecOptEntity, ProductSpecOptRepo> {
